...
describe("Assert Scrollable Section", () => {
    ...
    fit("Assert various search boxes and search result", () => {
    ...
    //Scroll to 160 rows are shown
    //browser.executeScript('window.scrollTo(0,160)');

for(let i=0;i< 20;i++)
{
    Scrollable_Page.scroll.get(i).click();
}
